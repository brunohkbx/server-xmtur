...
void CMonsterAttr::LoadAttr(char* filename)
{
	...
	while ( true )
	{
		...
		if ( Token == NUMBER )
		{
			...
			this->m_MonsterAttr[n].m_Hp = this->m_MonsterAttr[n].m_Hp - (INT)(this->m_MonsterAttr[n].m_Hp / 100.0f * Configs.MonsterHp);
			...
			if ( this->m_MonsterAttr[n].m_Level <= 24 && this->m_MonsterAttr[n].m_Index < 50)
			{
					 ...
					 this->m_MonsterAttr[n].m_Level == 24 )
				{
					...
					modiryvalue-= modiryvalue*Configs.MonsterHPAdjust/100;
			...
			if ( this->m_MonsterAttr[n].m_Level  <= 19 && this->m_MonsterAttr[n].m_Index  < 50 )
			{
				if ( this->m_MonsterAttr[n].m_Level == 13 ||
					 ...
					 this->m_MonsterAttr[n].m_Level == 19 )
				 {
					...
					modiryvaluemin -= modiryvaluemin*Configs.MonsterHPAdjust/100;
					modiryvaluemax -= modiryvaluemax*Configs.MonsterHPAdjust/100;

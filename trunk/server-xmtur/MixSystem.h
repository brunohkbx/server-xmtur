...
enum CHAOS_TYPE
{
	...
	CHAOS_TYPE_CHERRYBLOSSOM_MIX = 0x29,
	CHAOS_TYPE_SOCKET_SEED_EXTRACT_MIX = 0x2A,
	CHAOS_TYPE_SOCKET_SPHERE_COMPOSITE_MIX = 0x2B,
	CHAOS_TYPE_SOCKET_SPHERE_SET_MIX = 0x2C,
	CHAOS_TYPE_SOCKET_SPHERE_REMOVE_MIX = 0x2D,
...
public:
	...
	void BreakItemOption(LPOBJ lpObj);
	...
	//Season 5 Custom Addons
	BOOL CreateSemicronBook(LPOBJ gObj);
	BOOL SealedBoxMix(LPOBJ gObj);
	BOOL Extreme_CustomWingMixes(LPOBJ gObj);

...
void CEledoradoEvent::Run()
{
	...
	else
	{
		...
		if ( ( Time - this->GoldGoblenEventStartTime ) > Configs.EledoradoGoldGoblenRegenTime * 60000 )
		{
			this->GoldGoblenEventStartTime = Time;
			this->RegenGoldGoblen();
		}

		if ( ( Time - this->TitanEventStartTime ) > Configs.EledoradoTitanRegenTime * 60000 )
		{
			this->TitanEventStartTime = Time;
			this->RegenTitan();
		}

		if ( ( Time - this->GoldDerconEventStartTime ) > Configs.EledoradoGoldDerconRegenTime * 60000 )
		{
			this->GoldDerconEventStartTime = Time;
			this->RegenGoldDercon();
		}

		if ( ( Time - this->DevilLizardKingEventStartTime ) > Configs.EledoradoDevilLizardKingRegenTime * 60000 )
		{
			this->DevilLizardKingEventStartTime = Time;
			this->RegenDevilLizardKing();
		}

		if ( ( Time - this->KanturEventStartTime ) > Configs.EledoradoDevilTantarosRegenTime * 60000 )
		{
			this->KanturEventStartTime = Time;
			this->RegenKantur();
		}
		...
		//Season 4.5 addon start
		if ( ( Time - this->GoldenRabbitRegenTime ) > Configs.EledoradoGoldenRabbitRegenTime * 60000 )
		{
			this->GoldenRabbitRegenTime = Time;
			this->RegenGoldenRabbit();
		}

		if ( ( Time - this->GoldenDarkKnightRegenTime ) > Configs.EledoradoGoldenDarkKnightRegenTime * 60000 )
		{
			this->GoldenDarkKnightRegenTime = Time;
			this->RegenGoldenDarkKnight();
		}

		if ( ( Time - this->GoldenDevilRegenTime ) > Configs.EledoradoGoldenDevilRegenTime * 60000 )
		{
			this->GoldenDevilRegenTime = Time;
			this->RegenGoldenDevil();
		}

		if ( ( Time - this->GoldenMonsterRegenTime ) > Configs.EledoradoGoldenMonsterRegenTime * 60000 )
		{
			this->GoldenMonsterRegenTime = Time;
			this->RegenGoldenMonster();
		}

		if ( ( Time - this->GoldenCrustRegenTime ) > Configs.EledoradoGoldenCrustRegenTime * 60000 )
		{
			this->GoldenCrustRegenTime = Time;
			this->RegenGoldenCrust();
		}

		if ( ( Time - this->GoldenSatirosRegenTime ) > Configs.EledoradoGoldenSatirosRegenTime * 60000 )
		{
			this->GoldenSatirosRegenTime = Time;
			this->RegenGoldenSatiros();
		}

		if ( ( Time - this->GoldenTwintailRegenTime ) > Configs.EledoradoGoldenTwintailRegenTime * 60000 )
		{
			this->GoldenTwintailRegenTime = Time;
			this->RegenGoldenTwintail();
		}

		if ( ( Time - this->GoldenIronKnightRegenTime ) > Configs.EledoradoGoldenIronKnightRegenTime * 60000 )
		{
			this->GoldenIronKnightRegenTime = Time;
			this->RegenGoldenIronKnight();
		}

		if ( ( Time - this->GoldenNeipinRegenTime ) > Configs.EledoradoGoldenNeipinRegenTime * 60000 )
		{
			this->GoldenNeipinRegenTime = Time;
			this->RegenGoldenNeipin();
		}

		if ( ( Time - this->GoldenGreatDragonRegenTime ) > Configs.EledoradoGoldenGreatDragonRegenTime * 60000 )
		{
			this->GoldenGreatDragonRegenTime = Time;
			this->RegenGoldenGreatDragon();
		}
	...
	for (n=0;n<OBJ_MAXMONSTER;n++)
	{
		if ( gObj[n].Class == 79 )
		{
			...
			if ( SelMap == -1 )
			{
				...
				GCServerMsgStringSendAll((char*)szTemp,0);
			}

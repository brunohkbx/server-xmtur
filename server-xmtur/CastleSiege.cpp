...
#include "CastleSiege.h"
 ...
 //Set Linker to compile this whole code (maybe it's better to use ifdef... dunno)
...
void CCastleSiege::CheckCsDbNpcAlive()
{
	...
	{
		for( std::vector<_CS_NPC_DATA>::iterator it = m_vtNpcData.begin(); it != this->m_vtNpcData.end(); it++ )
		{
			_CS_NPC_DATA & NpcData = _CS_NPC_DATA(*it);

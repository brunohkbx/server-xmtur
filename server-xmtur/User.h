...
enum MAP_INDEX
{
	...
	MAP_INDEX_DOPPELGANGER2 = 66,
	MAP_INDEX_DOPPELGANGER3 = 67,
	MAP_INDEX_DOPPELGANGER4 = 68,
	MAP_INDEX_IMPERIALFORT1 = 69,
	MAP_INDEX_IMPERIALFORT2 = 70,
	MAP_INDEX_IMPERIALFORT3 = 71,
	MAP_INDEX_IMPERIALFORT4 = 72,
	MAP_INDEX_LORENMARKET = 79,
};
...
struct OBJECTSTRUCT
{
	...
	//Custom Points Sytem
	DWORD ExtremeTickCount;
	int ExtremePoints;

	//Marry System
	char HusbandWifeName[11];
	BOOL IsMarried;
	DWORD MarryProposeTime;
	int MarryTarget;

...
private:
	...
	//Unused o.O
    unsigned short m_sReqAG[MAX_SKILL]; //0x11944
    unsigned short m_sReqShield[MAX_SKILL]; //0x11DF4
    unsigned short m_sDuration[MAX_SKILL]; //0x122A4

    unsigned short m_sReqStrength[MAX_SKILL]; //0x12754
    unsigned short m_sReqDexterity[MAX_SKILL]; //0x12C04
